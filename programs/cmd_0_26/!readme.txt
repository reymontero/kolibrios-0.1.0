...
-----------------------------------------------------------------------
  ...
  CMD - Command Line Interpreter for Menuet
	...
	programm. It supports 14 commands, such as cp (copy file),
	...
	&, / and and +. Use & sumbol to enter params. For example,
	...
	Source code of this program is not optimized yet.
...
-----------------------------------------------------------------------
  ...
  Доступные команды:
	...
	pause         - ожидать нажатие клавиши. Используется для 
                        ...
                        echo Press ane key to continue, ESC - cancel.
                        pause
                        del cmd.asm
...
-----------------------------------------------------------------------
  ...
  Использование IPC во внешних программах:
	...
	ВНИМАНИЕ: После запуска любой другой программы из CMD, ее
		  окно автоматичеки деактивируется. Поэтому, прежде
		  чем нажать на клавишу для функции getkey, вы должны
		  навести указатель мышки на окно CMD и нажать на ее
		  левую клавишу.
